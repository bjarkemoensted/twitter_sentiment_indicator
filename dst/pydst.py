...
def get_tableinfo(
    ...
    return DSTResponse(response=get_noSSL(url), entrypoint="tableinfo", lang=lang, fmt=fmt)
...
def get_data(
    ...
    return DSTResponse(
        response=get_noSSL(url, stream=streaming),
        entrypoint="data",
